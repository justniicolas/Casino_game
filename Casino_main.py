...
import math
import Casino_jeu
import Casino_joueur


# ****** programme du jeu de la roulette **********
print("Bienvenue au Casino, voici le jeu de la Roulette !")
...
while j != 0 :
        ...
        if joueur1.porte_monnaie == 0:
                print("\nVous n'avez plus d'argent ! Au revoir et à bientôt au Casino ")
                j=0
        else:
                r=input(" Voulez vous rejouer ? [1] ou [2] ")
                if r == '1' : 
                        j=1
                else:
                        print("Au revoir et à bientôt au Casino ")
                        j=0
